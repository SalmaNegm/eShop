	...
	<ul class="left_menu">
		...
		<li class="odd"><a href="adminProducts.php">Products</a></li>
		<ul>
			<li class="sub_odd"><a  href="adminProducts.php">Add New</a></li>
			<li class="sub_odd"><a href="adminEditProduct.php">Edit</a></li>
			<li class="sub_odd"><a href="adminDeleteProduct.php">Delete</a></li>
		</ul>
